...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("2fe5c473-43a5-466f-bc02-a0f05f091abb/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_psoc3_pins_v1_10
		#(.id("2fe5c473-43a5-466f-bc02-a0f05f091abb/20681f4c-d171-47ae-a1cb-d832cd711191"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("2fe5c473-43a5-466f-bc02-a0f05f091abb/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__J1_POT_net;
	wire [0:0] tmpFB_0__J1_POT_net;
	wire [0:0] tmpIO_0__J1_POT_net;
	wire [0:0] tmpINTERRUPT_0__J1_POT_net;
	electrical [0:0] tmpSIOVREF__J1_POT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		J1_POT
		 (.oe(tmpOE__J1_POT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J1_POT_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__J1_POT_net[0:0]}),
		  .siovref(tmpSIOVREF__J1_POT_net),
		  .interrupt({tmpINTERRUPT_0__J1_POT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J1_POT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("e3f92601-b3be-45e0-bd44-8a7a82c3d19f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d25d8f46-1855-4458-bc33-7f08ca66486e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__CS_J2_net;
	wire [0:0] tmpFB_0__CS_J2_net;
	wire [0:0] tmpIO_0__CS_J2_net;
	wire [0:0] tmpINTERRUPT_0__CS_J2_net;
	electrical [0:0] tmpSIOVREF__CS_J2_net;

	cy_psoc3_pins_v1_10
		#(.id("37caf085-ab2e-4b2f-9754-b9735fb5a1e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		CS_J2
		 (.oe(tmpOE__CS_J2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CS_J2_net[0:0]}),
		  .io({tmpIO_0__CS_J2_net[0:0]}),
		  .siovref(tmpSIOVREF__CS_J2_net),
		  .interrupt({tmpINTERRUPT_0__CS_J2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CS_J2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CS_J3_net;
	wire [0:0] tmpFB_0__CS_J3_net;
	wire [0:0] tmpIO_0__CS_J3_net;
	wire [0:0] tmpINTERRUPT_0__CS_J3_net;
	electrical [0:0] tmpSIOVREF__CS_J3_net;

	cy_psoc3_pins_v1_10
		#(.id("91736e0f-f420-4710-b596-ab19b227a7e9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		CS_J3
		 (.oe(tmpOE__CS_J3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CS_J3_net[0:0]}),
		  .io({tmpIO_0__CS_J3_net[0:0]}),
		  .siovref(tmpSIOVREF__CS_J3_net),
		  .interrupt({tmpINTERRUPT_0__CS_J3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CS_J3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J2_LIM_net;
	wire [0:0] tmpFB_0__J2_LIM_net;
	wire [0:0] tmpIO_0__J2_LIM_net;
	wire [0:0] tmpINTERRUPT_0__J2_LIM_net;
	electrical [0:0] tmpSIOVREF__J2_LIM_net;

	cy_psoc3_pins_v1_10
		#(.id("4255210a-73d4-403c-b98f-0875f7671877"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J2_LIM
		 (.oe(tmpOE__J2_LIM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J2_LIM_net[0:0]}),
		  .io({tmpIO_0__J2_LIM_net[0:0]}),
		  .siovref(tmpSIOVREF__J2_LIM_net),
		  .interrupt({tmpINTERRUPT_0__J2_LIM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J2_LIM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J3_LIM_net;
	wire [0:0] tmpFB_0__J3_LIM_net;
	wire [0:0] tmpIO_0__J3_LIM_net;
	wire [0:0] tmpINTERRUPT_0__J3_LIM_net;
	electrical [0:0] tmpSIOVREF__J3_LIM_net;

	cy_psoc3_pins_v1_10
		#(.id("db7c1571-c0e4-4e86-9842-7fc2704b440b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J3_LIM
		 (.oe(tmpOE__J3_LIM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J3_LIM_net[0:0]}),
		  .io({tmpIO_0__J3_LIM_net[0:0]}),
		  .siovref(tmpSIOVREF__J3_LIM_net),
		  .interrupt({tmpINTERRUPT_0__J3_LIM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J3_LIM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J1_EN_net;
	wire [0:0] tmpFB_0__J1_EN_net;
	wire [0:0] tmpIO_0__J1_EN_net;
	wire [0:0] tmpINTERRUPT_0__J1_EN_net;
	electrical [0:0] tmpSIOVREF__J1_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("e81b6774-c255-4027-9fcc-1ca60f370203"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		J1_EN
		 (.oe(tmpOE__J1_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J1_EN_net[0:0]}),
		  .io({tmpIO_0__J1_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__J1_EN_net),
		  .interrupt({tmpINTERRUPT_0__J1_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J1_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("f546eaa1-2bd7-45ce-bbc2-ed92c1fd1d82"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__J1_STEP_net;
	wire [0:0] tmpFB_0__J1_STEP_net;
	wire [0:0] tmpIO_0__J1_STEP_net;
	wire [0:0] tmpINTERRUPT_0__J1_STEP_net;
	electrical [0:0] tmpSIOVREF__J1_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("46177937-176d-48fd-9a80-ab0f3e633b7a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J1_STEP
		 (.oe(tmpOE__J1_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J1_STEP_net[0:0]}),
		  .io({tmpIO_0__J1_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__J1_STEP_net),
		  .interrupt({tmpINTERRUPT_0__J1_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J1_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J1_DIR_net;
	wire [0:0] tmpFB_0__J1_DIR_net;
	wire [0:0] tmpIO_0__J1_DIR_net;
	wire [0:0] tmpINTERRUPT_0__J1_DIR_net;
	electrical [0:0] tmpSIOVREF__J1_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("ccf55ad8-5fc8-4e4f-aaa3-3e4c6f9f69b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J1_DIR
		 (.oe(tmpOE__J1_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J1_DIR_net[0:0]}),
		  .io({tmpIO_0__J1_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__J1_DIR_net),
		  .interrupt({tmpINTERRUPT_0__J1_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J1_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J2_EN_net;
	wire [0:0] tmpFB_0__J2_EN_net;
	wire [0:0] tmpIO_0__J2_EN_net;
	wire [0:0] tmpINTERRUPT_0__J2_EN_net;
	electrical [0:0] tmpSIOVREF__J2_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("03fb1e12-133c-40f4-9b54-691ca550e707"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		J2_EN
		 (.oe(tmpOE__J2_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J2_EN_net[0:0]}),
		  .io({tmpIO_0__J2_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__J2_EN_net),
		  .interrupt({tmpINTERRUPT_0__J2_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J2_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J2_STEP_net;
	wire [0:0] tmpFB_0__J2_STEP_net;
	wire [0:0] tmpIO_0__J2_STEP_net;
	wire [0:0] tmpINTERRUPT_0__J2_STEP_net;
	electrical [0:0] tmpSIOVREF__J2_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("0b20e87b-c804-4057-aaba-2d874b7f0666"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J2_STEP
		 (.oe(tmpOE__J2_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J2_STEP_net[0:0]}),
		  .io({tmpIO_0__J2_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__J2_STEP_net),
		  .interrupt({tmpINTERRUPT_0__J2_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J2_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J2_DIR_net;
	wire [0:0] tmpFB_0__J2_DIR_net;
	wire [0:0] tmpIO_0__J2_DIR_net;
	wire [0:0] tmpINTERRUPT_0__J2_DIR_net;
	electrical [0:0] tmpSIOVREF__J2_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("092db653-cf3c-4402-8c48-6893d402f760"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J2_DIR
		 (.oe(tmpOE__J2_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J2_DIR_net[0:0]}),
		  .io({tmpIO_0__J2_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__J2_DIR_net),
		  .interrupt({tmpINTERRUPT_0__J2_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J2_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J3_EN_net;
	wire [0:0] tmpFB_0__J3_EN_net;
	wire [0:0] tmpIO_0__J3_EN_net;
	wire [0:0] tmpINTERRUPT_0__J3_EN_net;
	electrical [0:0] tmpSIOVREF__J3_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("fc7f4966-5634-4304-b0a7-034d330f3d8e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		J3_EN
		 (.oe(tmpOE__J3_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J3_EN_net[0:0]}),
		  .io({tmpIO_0__J3_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__J3_EN_net),
		  .interrupt({tmpINTERRUPT_0__J3_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J3_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J3_STEP_net;
	wire [0:0] tmpFB_0__J3_STEP_net;
	wire [0:0] tmpIO_0__J3_STEP_net;
	wire [0:0] tmpINTERRUPT_0__J3_STEP_net;
	electrical [0:0] tmpSIOVREF__J3_STEP_net;

	cy_psoc3_pins_v1_10
		#(.id("4b7c23c2-d138-4ac1-ad89-ebda32d05c64"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J3_STEP
		 (.oe(tmpOE__J3_STEP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J3_STEP_net[0:0]}),
		  .io({tmpIO_0__J3_STEP_net[0:0]}),
		  .siovref(tmpSIOVREF__J3_STEP_net),
		  .interrupt({tmpINTERRUPT_0__J3_STEP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J3_STEP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__J3_DIR_net;
	wire [0:0] tmpFB_0__J3_DIR_net;
	wire [0:0] tmpIO_0__J3_DIR_net;
	wire [0:0] tmpINTERRUPT_0__J3_DIR_net;
	electrical [0:0] tmpSIOVREF__J3_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("be8a6d50-15c5-4e01-bcfb-8699889ebb3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		J3_DIR
		 (.oe(tmpOE__J3_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__J3_DIR_net[0:0]}),
		  .io({tmpIO_0__J3_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__J3_DIR_net),
		  .interrupt({tmpINTERRUPT_0__J3_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__J3_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("8f8c4cf0-1efa-46b3-afdb-2f85bcfd8d56"),
		  .source_clock_id(""),
		  .divisor(0),
