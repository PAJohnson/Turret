...
# Date: Tue, 05 May 2020 04:05:14 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 7 15} [list [get_pins {ClockBlock/dclk_glb_1}]]
create_generated_clock -name {ADC_DelSig_1_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 23 47} -nominal_period 319.4444444444444 [list [get_pins {ClockBlock/aclk_glb_0}]]
...
# Project: C:\Users\pajoh\projects\Turret\PSoC\turret_psoc\3dof.cydsn\3dof.cyprj
# Date: Tue, 05 May 2020 04:05:08 GMT
