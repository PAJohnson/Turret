...
*
* \funcusage
*  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_Read  
*******************************************************************************/
...
* preferred ADC_DelSig_1_Bypass_P03_Read() API because the 
* ADC_DelSig_1_Bypass_P03_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: ADC_DelSig_1_Bypass_P03_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use ADC_DelSig_1_Bypass_P03_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - ADC_DelSig_1_Bypass_P03_0_INTR       (First pin in the list)
    *  - ADC_DelSig_1_Bypass_P03_1_INTR       (Second pin in the list)
    *  - ...
    *  - ADC_DelSig_1_Bypass_P03_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_SetInterruptMode
    *******************************************************************************/
    void ADC_DelSig_1_Bypass_P03_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & ADC_DelSig_1_Bypass_P03_0_INTR) != 0u) 
		{ 
			 ADC_DelSig_1_Bypass_P03_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet ADC_DelSig_1_Bypass_P03_SUT.c usage_ADC_DelSig_1_Bypass_P03_ClearInterrupt
    *******************************************************************************/
